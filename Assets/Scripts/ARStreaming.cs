...
namespace IBM.Watsson.Examples
{
    public class ARStreaming : MonoBehaviour
    {
        ...
        GameObject paul;
        GameObject logan;
        Animator paulAnimator;
        Animator paulFaceAnimator;
        ...
        private void Update()
        {
            ...
            if (paul != null)
            {
                paulAnimator = GameObject.Find("idle_1").GetComponent<Animator>();
                paulFaceAnimator = GameObject.Find("MC_1_Face").GetComponent<Animator>();
                characterLoaded = true;
            }
            else if (logan != null)
            {
                loganAnimator = GameObject.Find("idle_2").GetComponent<Animator>();
                loganFaceAnimator = GameObject.Find("MC_2_Face").GetComponent<Animator>();
                characterLoaded = true;
            }
        }
